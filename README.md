...
Application supports publising of unique request number to Logs or Kakfa stream controlled by applcation.properties, key name publisher possible value logger and kafka
